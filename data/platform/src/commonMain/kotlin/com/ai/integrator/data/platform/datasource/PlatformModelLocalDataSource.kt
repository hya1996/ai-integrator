...
class PlatformModelLocalDataSource {
    ...
    fun getModelList(): Flow<List<PlatformModelInfo>> {
        return flowOf(models)
    }

    suspend fun getModelById(id: Long): PlatformModelInfo? {
        return models.find { it.modelId == id }
    }
}