...
object IMCenter {
    ...
    // todo replace thread safe map
    private val messageHandlerMap = mutableMapOf<HandlerKey<*>, IMMessageHandler>()
    private val messageReceiveListenJobMap = mutableMapOf<HandlerKey<*>, Job>()
